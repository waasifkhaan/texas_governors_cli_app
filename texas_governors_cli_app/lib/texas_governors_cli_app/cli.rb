class TexasGovernorsCliApp::CLI 
  ...
  def list_governor_names
    ...
    puts LINE
    puts "Type the index number of the respectable governor you would like to know more about ? or type 'exit' to quit "
    puts LINE
    puts LINE
    governor_details
  end 
  ...
  def governor_details
    ...
    input = STDIN.gets.strip.downcase 
        ...
        if input.to_i.between?(1,TexasGovernorsCliApp::Governor.create_from_collection.size)
            ...
            puts LINE
            puts "Type the index number or type list to print the list of governors again "
        elsif input == "list"
          list_governor_names
            puts "Type the index number or type list to print the list of governors again "
